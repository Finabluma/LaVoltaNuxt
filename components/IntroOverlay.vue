...
<template>
    <div v-if="show"
        class="intro-overlay fixed top-0 left-0 z-[100] w-full h-full bg-white text-firstlight dark:bg-secondark dark:text-firstdark flex justify-center items-center overflow-hidden"
        ref="overlay">
